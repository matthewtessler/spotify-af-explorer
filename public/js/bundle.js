      ...
      s.getAudioFeaturesForTracks(ids, function(err,data) {
        if (err) {
          ...
          for (var i=0; i < tracksList.length; i++) {
            searchResultsDiv.innerHTML += "<div class='col-lg-3'><div class='panel panel-default'><div class='panel-heading'>" + tracksList[i].name + " <small>Track</small></div><div class='panel-body'>" + data.audio_features[i].danceability + "</div></div></div>";
          }
